    ...
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                ...
                <input type="text" v-model="user.phone_number" v-validate="'required'" name="phone_number" class="form-control" :class="{ 'is-invalid': submitted && errors.has('phone_number') }" />
                <div v-if="submitted && errors.has('phone_number')" class="invalid-feedback">{{ errors.first('phone_number') }}</div>
            </div>
            <div class="form-group">
